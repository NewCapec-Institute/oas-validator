...
package com.newcapec.institute.oasv.compatibility.validators.schema.response;

import com.newcapec.institute.oasv.diffvalidation.api.OasDiffValidationContext;
import com.newcapec.institute.oasv.compatibility.validators.schema.SchemaTypeFormatChangeValidator;
import com.newcapec.institute.oasv.compatibility.validators.schema.TypeFormat;

import java.util.Arrays;
import java.util.Collections;
import java.util.List;

import static com.newcapec.institute.oasv.diffvalidation.util.OasDiffValidationContextUtils.isInResponse;
